/* Interactive exercises for Deutsch üben Phonetik A1 (from Lösungen p. 77–91). */
(function () {
  ...
  window.PHONETIK_A1_INTERACTIVE = {
    A1: [
      ...
      {title: "2b · Silben zählen", tracks: ["1.02"], figureRange: [1, 2], questions: [
    ...
    A2: [
      {title: "6b · Passende Antwort", tracks: ["1.17"], figureRange: [0, 2], questions: [
    ...
    A3: [
      {title: "9a · Text ordnen", tracks: ["1.38"], figureRange: [3, 4], questions: [
    ...
    B1: [
      {title: "1 · Miete oder Mitte?", tracks: ["2.01"], figureRange: [0, 1], questions: [
        choice("Sie sagt:", ["Miete", "Mitte"], 1),
        choice("Sie meint:", ["Miete", "Mitte"], 0)
      ]},
      {title: "2a · Lang oder kurz?", tracks: ["2.02"], figureRange: [1, 2], questions: [
      ...
      {title: "3 · Antworten", tracks: ["2.03"], questions: [
        ...
        text("Ist du ein Brötchen? →", ["Nein, Brot", "Nein, Brot."]),
    ...
    B2: [
      {title: "10a · Lang oder kurz?", tracks: ["2.15"], figureRange: [0, 1], questions: [
        text("Lang (Beispiel):", ["Frühling"]),
        text("Kurz:", ["Sommer", "Herbst", "Winter", "Wind", "Regen", "Schnee", "Grad", "scheinen", "heiß", "warm", "kalt", "grau", "dreißig"])
      ]}
    ],
    B3: [
      {title: "5a · a oder ä", tracks: ["2.27"], figureRange: [0, 1], questions: [
        text("Damen und Herren … Ankunft:", ["An", "Ankunft"]),
        text("… Abfahrt heute von Gleis:", ["acht", "Acht"]),
        text("Vielen Dank, dass Sie heute Meridio gewählt haben:", ["Dank", "Dank"]),
        text("Nächster Halt: Ansbach Haupt___:", ["bahnhof", "Bahnhof"])
      ]},
      {title: "6a · ä oder e", tracks: ["2.30"], figureRange: [1, 2], questions: [
        text("Handygesch___ft", ["äft", "äft"]),
        text("Universit___t", ["ät", "ät"]),
        text("Hot___l", ["el", "el"]),
        text("Zahn___rztin", ["ä", "ä"]),
        text("B___ckerei", ["ä", "ä"])
      ]}
    ],
    C8: [
      {title: "1 · Richtig ausgesprochen?", tracks: ["3.80"], figureRange: [0, 1], questions: [
        tf("Die Jacke passt nicht.", false),
        tf("Die Frau hat eine Freundin: Jackie.", true)
      ]},
      {title: "2a · j zuordnen", tracks: ["3.81"], figureRange: [1, 2], questions: [

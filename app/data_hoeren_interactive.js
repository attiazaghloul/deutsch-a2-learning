...
(function () {
  ...
  window.HOEREN_INTERACTIVE = {
    A1:[
      {title:"1a · Kursteilnehmer", tracks:[2], questions:[
    ...
    A2:[
      {title:"2a · Richtig oder falsch?",tracks:[4],questions:[
      ...
      {title:"2b · Antworte",tracks:[5],questions:[
    ...
    A3:[
      {title:"3a · Familienwörter",tracks:[6],questions:[
      ...
      {title:"3c · Wer ist das?",tracks:[8],questions:[
    ...
    A4:[{title:"4a · Wähle die richtige Lösung",tracks:[9],questions:[
    ...
    B1:[
      {title:"1a · Satzteile verbinden",tracks:[11],questions:[
      ...
      {title:"1b · Fragen schreiben",tracks:[12],questions:[
    ...
    B2:[{title:"2b · Wo stehen die Möbel?",tracks:[14],questions:[
    ...
    B3:[{title:"3a · Welche Aussagen stimmen?",tracks:[15],questions:[
    ...
    C1:[{title:"1a · Einkaufszettel",tracks:[17],questions:[
    ...
    C2:[{title:"2a · Gastfreundschaft",tracks:[19],questions:[
    ...
    C3:[{title:"3a · Einladungen verstehen",tracks:[21],questions:[
    ...
    D1:[{title:"1a · Richtig oder falsch?",tracks:[24],questions:[
    ...
    D2:[
      {title:"2a · Bilder und Gefühle",tracks:[26],questions:[
      ...
      {title:"2b · Fragen",tracks:[27],questions:[
    ...
    E1:[{title:"1a · Preise auswählen",tracks:[29],questions:[
    ...
    E2:[
      {title:"2a · Das Verkaufsgespräch",tracks:[31],questions:[
      ...
      {title:"2b · Antworte",tracks:[32],questions:[
    ...
    E3:[{title:"3a · Was bestellen die Personen?",tracks:[33],questions:[
    ...
    F1:[
      {title:"1a · Beim Arzt",tracks:[35],questions:[
      ...
      {title:"1b · Wähle",tracks:[35],questions:[
    ...
    F2:[
      {title:"2a · Bilder ordnen",tracks:[37],questions:[
      ...
      {title:"2b · Sportplan",tracks:[38],questions:[
    ...
    G1:[{title:"1a · Situationen den Bildern zuordnen",tracks:[39],questions:[
    ...
    G2:[{title:"2a · Bewerbungsgespräch",tracks:[41],questions:[
    ...
    G3:[{title:"3a · Nachrichten notieren",tracks:[43],questions:[
    ...
    G4:[{title:"4a · Termine eintragen",tracks:[46],questions:[
    ...
    H1:[
      {title:"1a · Richtige Pläne",tracks:[48],questions:[
      ...
      {title:"1b · Richtungswörter",tracks:[49],questions:[
    ...
    H2:[
      {title:"2a · Dialog 1 am Fahrkartenschalter",tracks:[50],questions:[
      multi("Welche Aussagen stimmen?",
        ["hin und zurück","Hund mitnehmen","muss umsteigen","Freitag Platz reservieren","Freitag Fensterplatz","Gleis 10","102 Euro","nur bar"],
        [0,1,3,4,6])
      ]},
      {title:"2a · Dialog 2 am Fahrkartenschalter",tracks:[51],questions:[
      multi("Welche Aussagen stimmen?",
    ...
    H3:[{title:"3a · Richtig oder falsch?",tracks:[53],questions:[
    ...
    H4:[
      {title:"4a · Im Reisebüro",tracks:[55],questions:[
      ...
      {title:"4b · Satzteile",tracks:[56],questions:[
    ...
    I1:[
      {title:"1a · Fernsehsendungen",tracks:[57],questions:[
      ...
      {title:"1b · Wer hat was gesehen?",tracks:[58],questions:[
    ...
    I2:[{title:"2a · Wetterberichte",tracks:[59],questions:[
    ...
    I3:[{title:"3a · Verkehrsfunk",tracks:[61],questions:[
